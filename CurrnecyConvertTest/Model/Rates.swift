...
struct Rates : Codable {
	...
	init(from decoder: Decoder) throws {
		...
		cNH = try values.decodeIfPresent(Double.self, forKey: .cNH)
		...
		xPD = try values.decodeIfPresent(Double.self, forKey: .xPD)
		xPF = try values.decodeIfPresent(Double.self, forKey: .xPF)
		xPT = try values.decodeIfPresent(Double.self, forKey: .xPT)
